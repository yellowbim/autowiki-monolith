...
@Schema(description = "그룹 내 개별 채팅에 대한 DTO")
public record ChatDto(
        ...
        public static ChatDto from(Chat chat) {
                return new ChatDto(
                        chat.getChatId(),
                        chat.getIpAddress(),
                        chat.getChatQuestion(),
                        chat.getChatAnswer(),
                        chat.getUseTokenCount(),
                        chat.getLatency(),
                        chat.getAction(),
                        chat.getSubAction(),
                        chat.getRecommendedQuestions(),
                        chat.getReferences(),
                        chat.getForm(),
                        chat.getChatType(),
                        chat.getSelectAnswer(),
                        chat.getTable(),
                        chat.getGraph(),
                        chat.getImages(),
                        chat.getChatHistoryList(),
                        chat.getSelectValue(),
                        chat.getExampleQuestionInfo(),
                        chat.getChatGroup().getChatGroupId(),
                        chat.getCreatedAt(),
                        chat.getUpdatedAt()
                );
        }
