package clabi.poc.domain.chat.dto.chat.req;
...
@Schema(description = "채팅 업데이트 요청을 위한 DTO")
public record UpdateChatReqDto (
        @NotNull
        @Schema(description = "채팅 ID", example = "2")
        int chatId,

        @Schema(description = "사용자의 IP 주소", example = "192.168.0.1")
        String ipAddress,
        ...
        @Schema(description = "형식 정보", example = "{\"category\": [{\"name\": \"연구개발\", \"values\": 71}, {\"name\": \"기반조성\", \"values\": 38}, {\"name\": \"일반행정\", \"values\": 25}], \"type\": \"check\"}")
