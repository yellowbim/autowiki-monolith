package clabi.poc.domain.auth.controller;
...
import clabi.poc.domain.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<RefreshTokenResponse> reIssueAccessToken(HttpServletRequest request, @RequestHeader("Refresh-Token") String refreshToken) throws Exception {
        RefreshTokenResponse newAccesToken = authService.reIssueAccessToken(request, refreshToken);
        return ResponseEntity.ok(newAccesToken);
    }
}
